const schoolSystem = {
  ...
  console.log(schoolSystem.schools[0].classRooms[0].students[3].firstName)

const students = ['anna', 'brian', 'chloe'];
 
const capitalize = student => `${student[0].toUpperCase()}${student.substring(1, student.length)}`

// Loop over an array and print each element
students.forEach( element => console.log('Hello ' + element));

const newStudents = students.map(capitalize)
